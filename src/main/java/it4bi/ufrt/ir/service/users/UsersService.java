...
public class UsersService {
	...
	public List<User> getUsers() {
		...
		users[0] = new User(0, "Richard", "Kondor", "Italy", UserSex.MALE, "1995-05-28");
		users[1] = new User(1, "Jack", "Willis", "Greece", UserSex.MALE, "1995-05-28");
		users[2] = new User(2, "Peter", "Brando", "France", UserSex.MALE, "1982-07-14");
